    ...
    async def get_transcript(self, callback):
        ...
        try:
            ...
            async def on_message(self, result, **kwargs):
                ...
                if should_stop or self.should_abort:
                    if self.should_abort:
            ...
            microphone.start()
            print("Microphone started. Speak into the microphone...")

            try:
                while not should_stop and not self.should_abort:
                ...
                print("Stopping microphone and Deepgram connection...")
                microphone.finish()
